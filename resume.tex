...
\begin{tightemize}
\item Analysed and interpreted statistical trends in geochemical data using Python, Excel, and Geochemists’ Workbench
...
\item Identification of foraminiferal morphospecies under a microscope 
\item Maintained microscope and stable isotope data using Excel 
\end{tightemize}
\sectionsep
...
\textbf{Resource Estimation:} Statistical porosity estimation based on well-log data using WinGslib \\
Science Communication \textbullet{} Geologic Mapping \textbullet{} Petrographic Microscopy  \textbullet{}  \LaTeX 
\sectionsep
